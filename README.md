...
This project is open to clone and use as a **reference or template**, but with the following conditions:
...
> This portfolio is licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
